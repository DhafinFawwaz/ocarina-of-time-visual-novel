...
screen quick_menu():
    ...
    if quick_menu:
        ...
        frame:
            background Solid("#00000000")  # semi-transparent black
            xalign 0.5
            yalign 1.0
            yoffset -23
...
screen main_menu():
    ...
    add Movie(size=(config.screen_width, config.screen_height), play="gui/main_menu/bg_video.webm", loop=True)
    add "gui/main_menu/logo.webp" xpos 0.525 ypos 0.48 anchor (0.5, 0.5) zoom 1.35
    add "gui/overlay/main_menu.png" xpos 0 ypos 0.5 anchor (0, 0.5)
...
style main_menu_frame:
    ...
    xalign 1.0
    xoffset -50  # Optional: add margin from the right
